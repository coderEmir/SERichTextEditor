...
#define Iphone6Scale WIDTH / 375
#define WidthScale(num) ((num) * Iphone6Scale)
...
//        NSBundle* bundle = [NSBundle bundleForClass:[ZSSRichTextEditor class]];
        ...
        UIView *toolbarCropper = [[UIView alloc] initWithFrame:CGRectMake(self.view.frame.size.width, 0, 44, 44)];
        toolbarCropper.autoresizingMask = UIViewAutoresizingFlexibleWidth;
...
- (void)createToolbar {
    ...
    [self.toolbar setBackgroundImage:[self imageAtPath:[self fileName:@"toolBarBg.png"]] forToolbarPosition:UIBarPositionAny barMetrics:0];
}
...
- (void)loadResources {
    ...
    NSString *filePath = [bundle pathForResource:@"editor.html" ofType:nil inDirectory:@"SERichTextEditor.bundle"];
    NSData *htmlData = [NSData dataWithContentsOfFile:filePath];
    NSString *htmlString = [[NSString alloc] initWithData:htmlData encoding:NSUTF8StringEncoding];
    
    //Add jQuery.js to the html file
    NSString *jquery = [bundle pathForResource:@"jQuery.js" ofType:nil inDirectory:@"SERichTextEditor.bundle"];
    ...
    NSString *beautifier = [bundle pathForResource:@"JSBeautifier.js" ofType:nil inDirectory:@"SERichTextEditor.bundle"];
    ...
    NSString *source = [bundle pathForResource:@"ZSSRichTextEditor.js" ofType:nil inDirectory:@"SERichTextEditor.bundle"];
...
{
    NSString *name = [[NSBundle bundleForClass:self.class] pathForResource:fileName ofType:nil inDirectory:@"SERichTextEditor.bundle"];
    if (![fileName containsString:@"ZSS"]) {
        NSLog(@"%@",name);
    }
    return name;
}
...
- (NSArray *)itemsForToolbar {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarBold]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *bold = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSbold.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setBold)];
        bold.label = @"bold";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarItalic]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *italic = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSitalic.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setItalic)];
        italic.label = @"italic";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarSubscript]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *subscript = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSsubscript.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setSubscript)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarSuperscript]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *superscript = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSsuperscript.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setSuperscript)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarStrikeThrough]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *strikeThrough = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSstrikethrough.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setStrikethrough)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUnderline]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *underline = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSunderline.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setUnderline)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRemoveFormat]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *removeFormat = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSclearstyle.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(removeFormat)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarFonts]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        ZSSBarButtonItem *fonts = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSfonts.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(showFontsPicker)];
        fonts.label = @"fonts";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUndo]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *undoButton = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSundo.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(undo)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRedo]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *redoButton = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSredo.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(redo)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyLeft]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignLeft = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSleftjustify.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignLeft)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyCenter]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignCenter = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSScenterjustify.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignCenter)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyRight]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignRight = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSrightjustify.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignRight)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyFull]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignFull = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSforcejustify.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(alignFull)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarParagraph]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *paragraph = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSparagraph.png"]]  style:UIBarButtonItemStylePlain target:self action:@selector(paragraph)];
        paragraph.label = @"p";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH1]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h1 = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSh1.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading1)];
        h1.label = @"h1";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH2]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h2 = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSh2.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading2)];
        h2.label = @"h2";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH3]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h3 = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSh3.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading3)];
        h3.label = @"h3";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH4]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h4 = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSh4.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading4)];
        h4.label = @"h4";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH5]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h5 = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSh5.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading5)];
        h5.label = @"h5";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarH6]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *h6 = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSh6.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(heading6)];
        h6.label = @"h6";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarTextColor]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *textColor = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSStextcolor.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(textColor)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarBackgroundColor]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *bgColor = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSbgcolor.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(bgColor)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUnorderedList]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *ul = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSunorderedlist.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setUnorderedList)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarOrderedList]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *ol = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSorderedlist.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setOrderedList)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarHorizontalRule]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *hr = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSShorizontalrule.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setHR)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarIndent]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *indent = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSindent.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setIndent)];
        indent.label = @"indent";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarOutdent]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *outdent = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSoutdent.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(setOutdent)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarInsertImage]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *insertImage = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSimage.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(insertImage)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarInsertImageFromDevice]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *insertImageFromDevice = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSimageDevice.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(insertImageFromDevice)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarInsertLink]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *insertLink = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSlink.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(insertLink)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRemoveLink]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *removeLink = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSunlink.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(removeLink)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarQuickLink]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *quickLink = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSquicklink.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(quickLink)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarViewSource]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *showSource = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:@"ZSSviewsource.png"]] style:UIBarButtonItemStylePlain target:self action:@selector(showHTMLSource:)];
...
- (void)showInsertLinkDialogWithLink:(NSString *)url title:(NSString *)title {
    ...
    [am setImage:[self imageAtPath:[self fileName:@"ZSSpicker.png"]] forState:UIControlStateNormal];
...
- (void)addCustomToolbarItemImageNames:(NSArray<NSString *> *)imageNames {
    ...
    for (NSInteger i = 0; i < imageNames.count; i ++) {
        NSString *imgeName = imageNames[i];
        imgeName = [imgeName stringByAppendingString:@"@2x.png"];
        ZSSBarButtonItem *item = [[ZSSBarButtonItem alloc] initWithImage:[self imageAtPath:[self fileName:imgeName]] style:UIBarButtonItemStylePlain target:self action:@selector(didTapCustomToolbarButton:)];
        item.label = imgeName;
        [items addObject:item];
        if (i == imageNames.count - 1) continue;
        [items addObject:flexibleitem];
    }
    [self.customZSSBarButtonItems addObjectsFromArray:items];
    [self buildToolbar];
}
...
- (void)showInsertImageDialogWithLink:(NSString *)url alt:(NSString *)alt {
    ...
    if ([NSProcessInfo instancesRespondToSelector:@selector(isOperatingSystemAtLeastVersion:)]) {
        ...
        #pragma mark - alertView升级
//        self.alertView = [[UIAlertController alloc] initWithTitle:NSLocalizedString(@"Insert Image", nil) message:nil delegate:self cancelButtonTitle:NSLocalizedString(@"Cancel", nil) otherButtonTitles:insertButtonTitle, nil];
//        self.alertView.alertViewStyle = UIAlertViewStyleLoginAndPasswordInput;
...
- (void)updateToolBarWithButtonName:(NSString *)name {
    ...
    for (ZSSBarButtonItem *item in items) {
        if (![item isKindOfClass:ZSSBarButtonItem.class]) continue;
