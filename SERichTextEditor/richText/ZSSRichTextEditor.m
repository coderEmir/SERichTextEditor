...
- (void)createToolbar {
    ...
    [self.toolbar setBackgroundImage:[UIImage imageNamed:@"toolBarBg"] forToolbarPosition:UIBarPositionAny barMetrics:0];
}
...
//    if (self.isScrollToolBar) return;
...
- (void)addCustomToolbarItemImageNames:(NSArray<NSString *> *)imageNames {
    ...
    for (NSInteger i = 0; i < imageNames.count; i ++) {
        ...
        ZSSBarButtonItem *item = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:imgeName] style:UIBarButtonItemStylePlain target:self action:@selector(didTapCustomToolbarButton:)];        
        item.label = imgeName;
